<div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            ...
            <a href="{{ route('categories.export', ['format' => 'excel', 'search' => $search, 'statusFilter' => $statusFilter, 'productFilter' => $productFilter]) }}"
                class="btn btn-success btn-sm me-1">
                <i class="mdi mdi-file-excel"></i> Excel
            </a>
            <a href="{{ route('categories.export', ['format' => 'pdf', 'search' => $search, 'statusFilter' => $statusFilter, 'productFilter' => $productFilter]) }}"
                    ...
                    @if (count($categories) > 0)
                        @foreach ($categories as $key => $category)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                    <img src="{{ $category->photo_url }}" class="avatar" loading="lazy" decoding="async"
                                        alt="{{ $category->name }}">
                                </td>
                                <td>{{ $category->name }}</td>
                                ...
                                <td>
                                    ...
                                    @endcanany
                                    @canany(['delete.categories', 'manage.categories'])
    ...
    @else
        <tr>
            <td colspan="4" class="text-center"><span class="text-danger">Add New Category</span>
                <a href="{{ route('categories.create') }}">here</a>
            </td>
        </tr>
        @endif
        </tbody>
