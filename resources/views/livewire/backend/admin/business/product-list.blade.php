        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                        <select class="form-select" id="category" wire:model.live="cityFilter">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('listings.export', ['format' => 'excel', 'search' => $search, 'statusFilter' => $statusFilter, 'cityFilter' => $popularFilter, 'categoryFilter' => $categoryFilter]) }}"
                            class="btn btn-success btn-sm me-1">
                            <i class="mdi mdi-file-excel"></i> Excel
                        </a>
                        <a href="{{ route('listings.export', ['format' => 'pdf', 'search' => $search, 'statusFilter' => $statusFilter, 'cityFilter' => $popularFilter, 'categoryFilter' => $categoryFilter]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($listings as $listing)
                                            <tr>
                                             ...
                                             <td>
                                            <img src="{{asset(asset('uploads/businessListings/logos/'.$listing->logo))}}" width="100px" height="100" class="img-thumbnail">
                                             </td>
                                                <td>
                                                    {{ $listing->name }}</strong>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="{{ route('product.details', ['categorySlug' => $listing->category->slug, 'productSlug' => $listing->slug]) }}"
                                                            class="btn btn-sm btn-info" title="View" target="_blank">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        @canany(['listings.edit', 'listings.manage'])
                                                            <a href="{{ route('listings.edit', $listing) }}"
                                                                class="btn btn-sm btn-primary" title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        @endcanany
                                                        @canany(['listings.delete', 'listings.manage'])
                                                            <button type="button"
