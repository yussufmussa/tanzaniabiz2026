        ...
        <div class="dashboard-widg-bar d-block">
            <div class="row">
                <div class="col-xl-12 col-lg-2 col-md-12 col-sm-12">
                                ...
                                <form action="{{ route('jobs.store') }}" method="post">@csrf
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control rounded"
                                                    placeholder="Junior Backend Developer" value="{{ old('title') }}"
                                                    required>
                                                @error('title')
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control rounded ht-150"
                                                    placeholder="Short description about the advertising position">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label class="mb-1">No. To Be Employed <span
                                                        class="text-danger">*</span></label>
                                                <input type="number" name="no_to_employed" class="form-control rounded"
                                                    placeholder="5" value="{{ old('no_to_employed') }}" required>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="row">
                                                ...
                                                <label class="mb-1">Job Opening Date<span
                                                        class="text-danger">*</span></label>
                                                <input type="date" name="job_opening_date" class="form-control rounded"
                                                    placeholder="2026-02-02" value="{{ old('job_opening_date') }}">
                                                @error('job_opening_date')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="mb-1">Job Closing Date<span
                                                        class="text-danger">*</span></label>
                                                <input type="date" name="job_closing_date" class="form-control rounded"
                                                    placeholder="2026-02-28" value="{{ old('job_closing_date') }}">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group">
                            <button class="btn theme-bg rounded text-light" type="submit">Post a Job</button>
                        </div>
                    </div>
                </form>
