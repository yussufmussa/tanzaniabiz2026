                ...
                <div class="section-heading text-center">
                    ...
                    <div class="counter-item mb-3">
                        <h3 class="counter__number text-color-2 font-size-50">
                            <span class="counter">{{$countAllBusiness}}</span>
                            <span class="count-symbol">+</span>
                        </h3>
                    </div>
                    <h2 class="sec__title mb-5">Company Choose Utalii Directory For Their Business <br>
                    List Yours Today</h2>
                </div><!-- end section-heading -->
                <div class="client-logo-box position-relative padding-top-200px padding-bottom-140px">
                    @foreach($business as $logo)
                    <a href="{{route('listings.details', $logo->slug)}}" class="client-logo-item bounce" data-toggle="tooltip" data-placement="top" title="{{$logo->title}}">
                        <img class="lazy" src="{{asset('photos/listing/logo/'.$logo->logo)}}" data-src="{{asset('photos/listing/logo/'.$logo->logo)}}" alt="{{$logo->title}}">
                    </a>
                    @endforeach
