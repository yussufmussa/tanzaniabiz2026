    ...
    <div class="row">
        @canany(['view.users', 'manage.users'])
            <div class="d-flex justify-content-end">
                <a type="submit" class="btn  btn-primary btn-sm mb-1 mt-0" href="{{ route('users.index') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                value="{{ $user->name }}" id="name" placeholder="Enter full name">
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="mobile_phone"
                                                ...
                                                value="{{ $user->mobile_phone }}" id="mobile_phone"
