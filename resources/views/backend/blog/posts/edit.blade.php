...
@section('contents')
    <div class="row">
        <div class="col-12">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('posts.update', $post->id) }}" data-parsley-validate
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="body" id="body" rows="12" class="form-control @error('body') is-invalid @enderror"
                                        placeholder="Write your blog post content here..">{{ old('body', $post->body) }}</textarea>
                                    @error('body')
                                        <div class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_description" id="meta_description" rows="3"
                                        ...
                                        placeholder="Brief description for search engines (recommended: 150-160 characters)">{{ old('meta_description', $post->meta_description) }}</textarea>
                    ...
                    <div class="col-lg-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_published" id="is_published"
                                        ...
                                        <option value="0" {{ old('is_published', $post->is_published ? 1 : 0) == 0 ? 'selected' : '' }}>
                                            Draft
                                        </option>
                                        <option value="1" {{ old('is_published', $post->is_published ? 1 : 0) == 1 ? 'selected' : '' }}>
                                            Published
                                        </option>
                                    </select>
                                    @error('is_published')
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Update Post</button>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="thumbnail">{{ $post->thumbnail ? 'Change' : 'Upload' }} Thumbnail Image <small
                                            class="text-muted">(optional)</small></label>
