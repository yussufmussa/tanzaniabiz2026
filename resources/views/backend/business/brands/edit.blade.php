    ...
    <div class="row">
        @canany(['brands.edit', 'brands.manage'])
            <div class="d-flex justify-content-end">
                <a type="submit" class="btn  btn-primary btn-sm mb-1 mt-0" href="{{ route('admin.brands.index') }}"><i
                            ...
                            <form action="{{ route('admin.brands.update', $brand->id) }}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="photoPreview" class="mt-3"
                                        style="{{ $brand->photo ? 'display:block;' : 'display:none;' }}">
                                        <img id="previewPhoto"
                                            src="{{ $brand->photo ? asset('uploads/brandPhotos/' . $brand->photo) : '' }}"
                                            alt="Preview"
                                ...
                                <div class="mb-3">
                                    <label for="forBrand" class="form-label fw-bold">Name</label>
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                    <i class="mdi mdi-content-save me-1"></i>Update Brand</button>
                        </div>
