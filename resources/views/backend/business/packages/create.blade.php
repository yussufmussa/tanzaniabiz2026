                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('billing_period') is-invalid @enderror"
                                            ...
                                            <option value="monthly"
                                                {{ old('billing_period') == 'monthly' ? 'selected' : '' }}>Monthly
                                            </option>
                                            <option value="yearly"
                                                {{ old('billing_period') == 'yearly' ? 'selected' : '' }}>Yearly
                                            </option>
                                            <option value="lifetime"
                                                {{ old('billing_period') == 'lifetime' ? 'selected' : '' }}>Lifetime
                                            </option>
                                        </select>
                                        ...
                                        <div class="col-md-4">
                                            @if ($feature->type === 'boolean')
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        {{ old('features.' . $feature->id) == 'true' ? 'checked' : '' }}>
                                            ...
                                            @elseif($feature->type === 'numeric')
                                                <input class="form-control" type="number"
                                                    ...
                                                    value="{{ old('features.' . $feature->id) }}" min="0"
                                            ...
                                            @elseif($feature->type === 'unlimited')
                                                <select class="form-select" name="features[{{ $feature->id }}]"
                                                    ...
                                                    <option value="unlimited"
                                                        {{ old('features.' . $feature->id) == 'unlimited' ? 'selected' : '' }}>
                                                        Unlimited</option>
                                                    <option value="custom"
                                                        {{ old('features.' . $feature->id) == 'custom' ? 'selected' : '' }}>
                                                        Custom Limit</option>
                                                </select>
                                            @else
