...
class LoginHistoryTable extends Component
{
    ...
    {
        return redirect()->route('admin.login.history.export.pdf', [
            'search' => $this->search,
    ...
    {
        return redirect()->route('admin.login.history.export.excel');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.backend.admin.user.login-history-table', [
            'logins' => $logins,
        ]);
    }
}
